...
#define MXC_GPIO_PIN_SSEC MXC_GPIO_PIN_7
#define MXC_GPIO_PORT_RTC MXC_GPIO2

mxc_gpio_cfg_t gpio_out_ssec;
...
void RTC_IRQHandler(void)
{
    ...
    if (flags & MXC_F_RTC_CTRL_SSEC_ALARM) {
        ...
        MXC_GPIO_OutToggle(MXC_GPIO_PORT_RTC, MXC_GPIO_PIN_SSEC);
...
int main(void)
{
    ...
    /* Setup output pin. */
    gpio_out_ssec.port = MXC_GPIO_PORT_RTC;
    gpio_out_ssec.mask = MXC_GPIO_PIN_SSEC;
    gpio_out_ssec.pad = MXC_GPIO_PAD_NONE;
    gpio_out_ssec.func = MXC_GPIO_FUNC_OUT;
    gpio_out_ssec.vssel = MXC_GPIO_VSSEL_VDDIO;
    gpio_out_ssec.drvstr = MXC_GPIO_DRVSTR_0;
    MXC_GPIO_Config(&gpio_out_ssec);


    MXC_RTC_SquareWaveStart(MXC_RTC_F_512HZ);
